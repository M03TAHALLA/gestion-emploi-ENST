            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="td-crud-operations">
                  <a href="{{ route('departements.edit', $departement->nom_departement) }}" class="">
                  ...
                  <form action="{{ route('departements.destroy', $departement->nom_departement) }}" method="POST" style="display: inline;">
                    @csrf
                    @method('DELETE')
