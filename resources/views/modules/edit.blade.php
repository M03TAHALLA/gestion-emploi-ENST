      ...
      <div class="container-section">
        ...
        <form action="{{ route('modules.update', $module->id) }}" method="POST">
            ...
            <div class="formbold-input-flex">
                <div class="formbold-input-group mt-3">
                    <input type="text" id="nomModuleInput" placeholder="Nom de module" class="form-control" name="nom_module" value="{{ $module->nom_module }}">
                </div>
                <div class="formbold-input-group mt-3">
                    <select id="natureModuleInput" class="form-select" name="nature_module">
                        <option value="Disciplinaire" @if($module->nature_module == 'Disciplinaire') selected @endif>Disciplinaire</option>
                        <option value="Complementaire" @if($module->nature_module == 'Complementaire') selected @endif>Complémentaire</option>
                    </select>
                </div>
            </div>
            <div class="formbold-input-flex">
                <div class="formbold-input-group mt-3">
                    <input type="number" id="volumeHoraireInput" placeholder="Volume horaire" class="form-control" name="volume_horaire" value="{{ $module->volume_horaire }}">
                </div>
                <div class="formbold-input-group mt-3">
                    <input type="text" id="nomFiliereInput" placeholder="Nom de filière" class="form-control" name="nom_filiere" value="{{ $module->nom_filiere }}">
                </div>
                <div class="formbold-input-group mt-3">
                    <input type="text" id="nomEnseignantInput" placeholder="Nom d'enseignant" class="form-control" name="nom_professeur" value="{{ $module->nom_professeur }}">
                </div>
            </div>
