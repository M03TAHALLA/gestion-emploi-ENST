...
<head>
  ...
  <title>Dashboard | Edit Enseignant</title>
  <!-- plugins:css -->
        ...
        <div class="formbold-form-wrapper">
          <form action="{{ route('enseignant.update', $enseignant->id) }}" method="POST">
              ...
              <div class="formbold-input-group">
                  ...
                  <input type="text" name="cin_enseignant" id="cin_enseignant" value="{{ $enseignant->cin_enseignant }}" class="formbold-form-input" required />
              </div>
              <div class="formbold-input-group">
                  <label for="nom_enseignant" class="formbold-form-label">Nom enseignant</label>
                  <input type="text" name="nom_enseignant" id="nom_enseignant" value="{{ $enseignant->nom_enseignant }}" class="formbold-form-input" required />
              </div>
              <div class="formbold-input-group">
                  <label for="prenom_enseignant" class="formbold-form-label">Prenom enseignant</label>
                  <input type="text" name="prenom_enseignant" id="prenom_enseignant" value="{{ $enseignant->prenom_enseignant }}" class="formbold-form-input" required />
              </div>
              <div class="formbold-input-group">
                  <label for="date_naissance" class="formbold-form-label">Date Naissance</label>
                  <input type="date" name="date_naissance" id="date_naissance" value="{{ $enseignant->date_naissance }}" class="formbold-form-input" required />
              </div>
              <div class="formbold-input-group">
                  <label for="email" class="formbold-form-label">Email</label>
                  <input type="email" name="email" id="email" value="{{ $enseignant->email }}" class="formbold-form-input" required />
              </div>
              <div class="formbold-input-group">
                  <label for="specialite" class="formbold-form-label">Spécialite</label>
                  <input type="text" name="specialite" id="specialite" value="{{ $enseignant->specialite }}" class="formbold-form-input" required />
              </div>
              <div class="formbold-input-group">
                  ...
                  <select class="formbold-form-select" name="situation" id="situation">
                      ...
                      <option value="Permanant" {{ $enseignant->situation == 'Permanant' ? 'selected' : '' }}>Permanant</option>
                      <option value="Vacataire" {{ $enseignant->situation == 'Vacataire' ? 'selected' : '' }}>Vacataire</option>
                  </select>
              </div>
              <div hidden class="formbold-input-group">
                  <label for="specialite" class="formbold-form-label">horaire_total</label>
                  <input type="text" value="{{ $enseignant->horaire_total }}" name="horaire_total" id="horaire_total" class="formbold-form-input" required />
              </div>
              <div class="formbold-input-group">
                  <label for="date_affectation" class="formbold-form-label">Date Affectation</label>
                  <input type="date" name="date_affectation" id="date_affectation" value="{{ $enseignant->date_affectation }}" class="formbold-form-input" required />
              </div>
              <div class="formbold-input-group">
                  ...
                  <select class="formbold-form-select" name="nom_departement" id="nom_departement">
                      ...
                      <option value="{{ $departement->nom_departement }}" {{ $enseignant->nom_departement == $departement->nom_departement ? 'selected' : '' }}>{{ $departement->nom_departement }}</option>
                      @endforeach
                  </select>
              </div>

              <button type="submit" class="formbold-btn">Mettre à jour Enseignant</button>
          </form>
        </div>
      </section>
    </div>
