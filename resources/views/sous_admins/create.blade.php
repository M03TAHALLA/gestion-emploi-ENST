  ...
  <div class="container-scroller">
    @include('layout.navbar')
      ...
      <div class="container-section">
        ...
        @endif
        <h4 style="margin-top:25px; color:#0039a6;">Créer un nouveau admin</h4>
        <form action="{{ route('admins.store') }}" method="POST" class="mx-auto mt-5">
            @csrf
            <div class="form-group">
                <label for="cin">CIN </label>
                <input type="text" id="cin" name="cin" value="{{ old('cin') }}" required class="form-control">
            </div>
            <div class="form-group">
                <label for="matricule">Matricule </label>
                <input type="text" id="matricule" name="matricule" value="{{ old('matricule') }}" required class="form-control">
            </div>
            <div class="form-group">
            ...
            <button type="submit" class="btn create-salle-button">Créer un nouveau admin</button>
        </form>
        </section>
    </div>
    <!-- main-panel ends -->
