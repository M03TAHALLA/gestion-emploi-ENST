  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="container-section">
        <section>
          <div class="head-section">
            ...
            <div class="right-section">
              ...
              <span>Tableau de board / </span><a href=""> Admins</a>
            </div>
          </div>
            @if (session('success'))
        ...
        <form action="{{ route('admins.update', $sousAdmin->id) }}" method="POST" class="mx-auto mt-5">
            @csrf
            @method('PUT')
            <div class="form-group">
                <label for="cin">CIN </label>
                <input type="text" id="cin" name="cin" value="{{ old('cin', $sousAdmin->cin) }}" required class="form-control" readonly>
            </div>
            <div class="form-group">
                <label for="matricule">Matricule </label>
                <input type="text" id="matricule" name="matricule" value="{{ old('matricule', $sousAdmin->matricule) }}" required class="form-control">
            </div>
            <div class="form-group">
                <label for="nom">Nom </label>
                <input type="text" id="nom" name="nom" value="{{ old('nom', $sousAdmin->nom) }}" required class="form-control">
            </div>
            <div class="form-group">
                <label for="prenom">Prenom </label>
                <input type="text" id="prenom" name="prenom" value="{{ old('prenom', $sousAdmin->prenom) }}" required class="form-control">
            </div>
            <div class="form-group">
                <label for="email">Email </label>
                <input type="text" id="email" name="email" value="{{ old('email', $sousAdmin->email) }}" required class="form-control">
            </div>
            <div class="form-group">
                <label for="password">Password </label>
                <input type="password" id="password" name="password" value="{{ old('password', $sousAdmin->password) }}" class="form-control">
                <input type="checkbox" id="show-password"> Show Password
            </div>
            <div class="form-group mt-3">
                <label for="aac">Année Académique:</label>
                <input type="text" id="aac" name="annee_academique" value="2024-2025" readonly class="form-control">
            </div>
            <button type="submit" class="btn create-salle-button">Mettre à jour admin</button>
        </form>
